filename = "rep_beta_persistentgamedata1.dat"
new_filename = "rep_persistentgamedata1.dat"
...
def remove_online_secrets(data):
    # update online version
    new_data = data[:0x18] + b'\x7e\x02\x00\x00\x7e\x02\x00\x00' + data[0x20:]
    # delete 638 - 640, avoid data miss position
    return new_data[:0x20 + 638] + new_data[0x20 + 641:]
...
if __name__ == "__main__":
    ...
    with open(filename, "rb") as file:
        ...
        print(checksum == old_checksum)
    
    data = remove_online_secrets(data)
